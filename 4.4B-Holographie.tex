...
$z_B$ einen Fehler von $5mm$ angesetzt haben. \textcolor{blue}{Leider kam es
  während der Durchführung zu einem Missverständniss, weswegen nur die erste
  positive Beugungsordnung vermessen wurde. Obwohl lediglich die erste
  Beugungsordnung vermessen wurde, konnten wir zusätzlich noch 
  2 weitere Beugungsordnungen beobachten.}
...
\end{axis}
\end{tikzpicture}
    \caption{Gemessene Werte für die Bildweite \textcolor{blue}{der ersten
